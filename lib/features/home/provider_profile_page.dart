                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text("${provider.rating.toStringAsFixed(1)}  (${provider.reviewsCount} avaliações)",
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
                  children: provider.categories.map((c) => BicoChip(label: c)).toList(),
                ),
              ],
            ),
          ),
          ...
          BicoCard(
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    "Preço base: R\$ ${provider.priceBase.toStringAsFixed(0)} ${provider.priceType}",
